...
class GeoScene(Group):
    ...
    def height_at(self, x: typing.SupportsFloat | typing.SupportsIndex, z: typing.SupportsFloat | typing.SupportsIndex) -> float:
        ...
        """
    @typing.overload
    def update(self, pos: Vector3) -> None:
        """
        Once per frame, with the ACTIVE camera position: tile LOD + scatter.
        """
    @typing.overload
    def update(self, pos: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], "FixedSize(3)"]) -> None:
        ...
    @property
    ...
    def height_min(self) -> float:
        ...
    @property
    def pack_world_size(self) -> float:
        ...
    @property
...
class ImuModel:
    """
    A named IMU noise model from a datasheet: `gyro` and `accel` NoiseModels (assign them to Imu.gyro_noise / Imu.accel_noise, then call reset()). Only the white-noise densities are datasheet figures; the parts publish no rate random walk in NoiseModel's units, so presets leave random_walk at zero. Imu's defaults ARE ImuModel.icm42688p().
    """
    @staticmethod
    def icm42688p() -> ImuModel:
        """
        TDK InvenSense ICM-42688-P: gyro 2.8 mdps/sqrt(Hz), accel 70 ug/sqrt(Hz) (datasheet DS-000347).
        """
    def __init__(self) -> None:
        ...
    def __repr__(self) -> str:
        ...
    @property
    def accel(self) -> NoiseModel:
        """
        Accelerometer NoiseModel (m/s^2 units).
        """
    @accel.setter
    def accel(self, arg0: NoiseModel) -> None:
        ...
    @property
    def gyro(self) -> NoiseModel:
        """
        Gyroscope NoiseModel (rad/s units).
        """
    @gyro.setter
    def gyro(self, arg0: NoiseModel) -> None:
        ...
    @property
    def name(self) -> str:
        ...
