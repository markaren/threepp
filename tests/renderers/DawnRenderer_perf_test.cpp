// DawnRenderer performance baseline test.
...
// build/tests/dawn_perf_baseline.txt.
...
TEST_CASE("DawnRenderer performance baseline", "[dawn][perf]") {
    REQUIRE_DAWN();
    ...
    // --- Create Dawn renderer and render target ---
    ...
    DawnRenderer renderer(*perfCanvas);
    ...
    // --- Write results ---
    {
        std::ofstream out("dawn_perf_baseline.txt");
    ...
    std::cout << "  Results written to dawn_perf_baseline.txt\n";
