...
namespace threepp {
     ...
     *   - A direction and length across a plane. In threepp the length will always be the Euclidean distance (straight-line distance) from (0, 0) to (x, y) and the direction is also measured from (0, 0) towards (x, y).
