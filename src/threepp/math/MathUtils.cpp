...
std::string math::generateUUID() {
    ...
    const auto d0 = static_cast<unsigned int>(static_cast<double>(dist(e2)) * 0xffffffff) | 0;
    const auto d1 = static_cast<unsigned int>(static_cast<double>(dist(e2)) * 0xffffffff) | 0;
    const auto d2 = static_cast<unsigned int>(static_cast<double>(dist(e2)) * 0xffffffff) | 0;
    const auto d3 = static_cast<unsigned int>(static_cast<double>(dist(e2)) * 0xffffffff) | 0;
