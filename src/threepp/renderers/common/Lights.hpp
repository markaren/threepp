// Backend-neutral light state computation.
// Extracted from renderers/gl/GLLights.hpp — contains zero GL API calls.

#ifndef THREEPP_COMMON_LIGHTS_HPP
#define THREEPP_COMMON_LIGHTS_HPP
...
#endif//THREEPP_COMMON_LIGHTS_HPP
