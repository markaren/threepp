// WGSL shader generation and feature flags for the Dawn renderer backend.
// Extracted from DawnRenderer.cpp to enable independent testing and iteration.

#ifndef THREEPP_DAWNSHADERS_HPP
#define THREEPP_DAWNSHADERS_HPP
