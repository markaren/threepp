// Shadow map rendering subsystem for the Dawn renderer.
// Manages the depth array texture, shadow pipelines, and per-light
// shadow pass rendering.

#ifndef THREEPP_DAWNSHADOWMAP_HPP
#define THREEPP_DAWNSHADOWMAP_HPP
...
#endif//THREEPP_DAWNSHADOWMAP_HPP
