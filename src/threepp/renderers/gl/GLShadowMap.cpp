...
namespace {
    ...
    void bindAndClearShadowTarget(Renderer& renderer, RenderTarget* target) {
...
struct GLShadowMap::Impl {
    ...
    void VSMPass(Renderer& _renderer, LightShadow* shadow, Camera* camera) {
    ...
    Material* getDepthMaterial(Renderer& _renderer, Object3D* /*object*/, BufferGeometry* /*geometry*/, Material* material, Light* light, float shadowCameraNear, float shadowCameraFar) {
    ...
    void renderObject(Renderer& _renderer, Object3D* object, Camera* camera, Camera* shadowCamera, Light* light) {
    ...
    void render(Renderer& _renderer, const std::vector<Light*>& lights, Object3D* scene, Camera* camera) {
...
void GLShadowMap::render(Renderer& renderer, const std::vector<Light*>& lights, Object3D* scene, Camera* camera) {
