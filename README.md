...
| ![Shooter](doc/screenshots/tps.png) *Third-person shooter ([projects/Shooter](examples/projects/Shooter))*             | ![Lidar](doc/screenshots/lidar.png) *Path-traced LIDAR simulation*                                       |
