...
function(add_example)
    ...
    if (DEFINED EMSCRIPTEN)
        ...
        set(LINK_FLAGS " --bind -sUSE_GLFW=3 -sASSERTIONS -sALLOW_MEMORY_GROWTH -sNO_DISABLE_EXCEPTION_CATCHING -sWASM=1")
        if (THREEPP_WITH_WGPU)
            set(LINK_FLAGS "${LINK_FLAGS} -sUSE_WEBGPU=1 -sASYNCIFY")
        else ()
