...
void Crane3R::setAngles(float j1, float j2, float j3) {
    parts_[0]->rotation.z = threepp::math::DEG2RAD * j1;
    parts_[1]->rotation.y = threepp::math::DEG2RAD * j2;
    parts_[2]->rotation.y = threepp::math::DEG2RAD * j3;
}
