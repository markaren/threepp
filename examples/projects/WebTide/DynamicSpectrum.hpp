...
namespace webtide {
    ...
    public:
        threepp::GPUTexture ht;
        threepp::GPUTexture dht;
        threepp::GPUTexture displacement;

        DynamicSpectrum(threepp::DawnRenderer& renderer, PhillipsSpectrum& initialSpectrum,
                        uint32_t textureSize, float tileSize)
            : ht(renderer, textureSize, textureSize, threepp::GPUTexture::Format::RG32Float),
              dht(renderer, textureSize, textureSize, threepp::GPUTexture::Format::RG32Float),
              displacement(renderer, textureSize, textureSize, threepp::GPUTexture::Format::RG32Float),
