...
namespace webtide {
    ...
    public:
        ...
        PhillipsSpectrum(threepp::WgpuRenderer& renderer, uint32_t textureSize, float tileSize,
                         float kMin = 0.0f, float kMax = 0.0f, float smallWaveLengthCutoff = 0.01f)
            : h0(renderer, textureSize, textureSize, threepp::WgpuTexture::Format::RGBA32Float),
              ...
              uniformBuffer_(renderer, 48), // 8 floats/u32 padded to 48 bytes (alignas 16)
            ...
            // Upload uniforms — 8 fields, alignas(16), 48 bytes total
            ...
            params.smallWaveLengthCutoff = smallWaveLengthCutoff;
            params.kMin = kMin;
            params.kMax = kMax;
            params._pad = 0.0f;
